...
$(document).on('click', '#submit-sale', function() { 
	...
	if(pname.length > 0 && pprice.length> 0 && enddate.length > 0 && cat > 0){
		...
		$.ajax({
			...
			$.ajax({
				url : "http://lhl.herokuapp.com/LHL/addsale",
				type: 'post',
				data : formData,
				success : function() {
...
$(document).on('click', '#active-winning', function() { 
		...
		$.ajax({
			url : "http://lhl.herokuapp.com/LHL/updatewinningbid",
			type: 'put',
			data : formData,
			success : function(data) {
				formData.senderid=5;
				...
				formData.text="You won an auction! Please check your pending payments. Have a good day!";
					$.ajax({
						url : "http://lhl.herokuapp.com/LHL/addmessage",
						type: 'post',
						data:formData,
						success : function(data) {
...
$(document).on('click', "#submit-name", function(event, ui) {
	...
	if(uname.length > 0){
		...
		$.ajax({
			url : "http://lhl.herokuapp.com/LHL/updatepname",
			type: 'put',
			data : formData,
			success : function(data) {
...
$(document).on('click', "#submit-image", function(event, ui) {
	...
	if(uimage.length > 0){
		...
		$.ajax({
			url : "http://lhl.herokuapp.com/LHL/updatepimage",
			type: 'put',
			data : formData,
			success : function(data) {
...
$(document).on('click', "#submit-price", function(event, ui) {
	...
	if(uprice > 0){
		...
		$.ajax({
			url : "http://lhl.herokuapp.com/LHL/updateprice",
			type: 'put',
			data : formData,
			success : function(data) {
...
$(document).on('click', "#submit-condition", function(event, ui) {
	...
	if(ucondition.length > 0){
		...
		$.ajax({
			url : "http://lhl.herokuapp.com/LHL/updatepcondition",
			type: 'put',
			data : formData,
			success : function(data) {
...
$(document).on('click', "#submit-description", function(event, ui) {
	...
	if(udescription.length > 0){
		...
		$.ajax({
			url : "http://lhl.herokuapp.com/LHL/updatepdescription",
			type: 'put',
			data : formData,
			success : function(data) {
...
$(document).on('pagebeforeshow', "#invoice-show", function(event, ui) {
		var id= invoiceID;
		$.ajax({
		url : "http://lhl.herokuapp.com/LHL/invoice/"+id,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
$(document).on('pagebeforeshow', "#bidcheckpage", function(event, ui){
	...
	var id= auctionBid;
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/auction/"+id,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
$(document).on('click', '#bidsubmitcheckout-button', function(){
		...
		$.ajax({
		url : "http://lhl.herokuapp.com/LHL/updatepaymentwinningbid",
		type : 'put',
		data : formData,
		dataType:"json",
		success: function(data, textStatus, jqXHR){
...
function GetAddress(addressid){
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/address/" + addressid,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function GetRankers(id){
	...
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/rankers/" + id,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function SaveAccount(){
	...
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/accounts/",
		type : 'post',
		data : formData,
		//contentType: "application/json",
		dataType:"json",
...
function DeleteAccounts(id){
	...
	if(decision == true) {
		$.mobile.loading("show");
		$.ajax({
			url : "http://lhl.herokuapp.com/LHL/accountsdelete/" + id,
			method: 'put',
			contentType: "application/json",
			dataType:"json",
			success : function(data, textStatus, jqXHR) {
...
function DeleteCategory(id){
	...
	if(decision == true) {
		$.mobile.loading("show");
		$.ajax({
			url : "http://lhl.herokuapp.com/LHL/categories/" + id,
			type: 'post',
			contentType: "application/json",
			dataType:"json",
			success : function(data, textStatus, jqXHR) {
...
function AccountLogin(username, password){
	...
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/login/"+username+"/"+password,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function GoProfile(id){
	...
	if(loginAccount.accountid == id){
		...
		$.ajax({
			url : "http://lhl.herokuapp.com/LHL/profiles/"+id,
			method: 'get',
			contentType: "application/json",
			dataType:"json",
			success : function(data, textStatus, jqXHR){
...
function SignUp(id){
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/accountsign/"+id,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function GetProduct(id){
	...
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/products/"+ id,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
		...
		$.ajax({
			url : "http://lhl.herokuapp.com/LHL/sales-product/"+ id,
			method: 'get',
			contentType: "application/json",
			dataType:"json",
			success : function(data, textStatus, jqXHR){
...
function Sortby(id){
	...
	if(sort == "true"){
		...
		var all= allSearch;
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/sortbyterms/"+id+"/"+term+"/"+all,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
	...
	if(catid != undefined){
		...
		$.ajax({
			url : "http://lhl.herokuapp.com/LHL/allProducts",
			method: 'get',
			contentType: "application/json",
			dataType:"json",
			success : function(data, textStatus, jqXHR){
			...
			if(isParent){
				...
				$.ajax({
					url : "http://lhl.herokuapp.com/LHL/sortProducts/"+ id+"/"+catid,
					method: 'get',
					contentType: "application/json",
					dataType:"json",
...
function AllSortby(id){
	...
	if(patid != undefined){
		$.ajax({
			url : "http://lhl.herokuapp.com/LHL/sortAllProducts/"+ id+"/"+patid,
			method: 'get',
			contentType: "application/json",
			dataType:"json",
			success : function(data, textStatus, jqXHR){
...
function GetBids(id){
	...
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/bidsproducts/"+id,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function GetShoppingCart(id){
	...
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/shoppingcart/"+id,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function BidUser(id){
	...
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/bidusers/"+id,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function PurchaseUser(id){
	...
	$.ajax({
		...
		$.ajax({
		url : "http://lhl.herokuapp.com/LHL/winningbid/"+id,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function SalesUser(id){
	...
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/salesusers/"+id,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function EndSale(pid){
	var formData = {id:pid};
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/updateDeactive",
		type: 'put',
		data : formData,
		success : function(data) {
		if(!isSale){
			...
			success : function(data) { 
				...
				$.ajax({
					...
					success: function(data){
						formData.creditid= data.creditinfo[0].creditid;
						$.ajax({
						url:"http://lhl.herokuapp.com/LHL/insertwinningbid",
						type:'post',
						data:formData,
						success: function(data){
						formData.subject="Auction: "+formData.auctionid; 
...
function GetAllProducts(id){
	...
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/categoryAll/"+ id,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function GetCategoryProducts(id){
	...
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/categoryProducts/"+ id,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function GetCategories(){
	...
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/category",
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function RankUser(info){
	...
	var formData = info;
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/rankuser/",
		type : 'post',
		dataType: 'json',
		data : formData,
...
function GetSubCategory(id){
	...
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/subcategory/"+id,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function GetAuctions(){
	...
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/auctions/"+ id,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
		...
		var id= loginAccount.accountid;
		$.ajax({
		url : "http://lhl.herokuapp.com/LHL/getwinningbids/"+id,
		type: 'get',
	    success : function(data) {
...
function GetSales(){
	...
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/sales/"+ id,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function AllSales(){
	...
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/sales/",
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function GetHistory(hid){
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/histories/"+ hid,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function GetInbox(id){
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/message-inbox/" + id,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function GetSent(id){
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/message-sent/" + id,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function GetMessage(id){
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/message-view/" + id,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function submitMessage(){
	...
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/accountid/" + user,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function DeleteMessageI(){
	...
	for(var i=0; i< inboxToDelete.length; i++){
		...
		$.ajax({
			url : "http://lhl.herokuapp.com/LHL/deletembox",
			type: 'put',
			data : formData,
			success : function() {   
...
function AddAccount(){
	...
	var formData = form.serializeArray();
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/accountscreated/",
		type: 'post',
		data : formData,
		success: function(errorThrown, textStatus, jqXHR){
    		alert('Account Created');
...
function ChangeFName(info){
	...
	var formData = info;
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/accountfname/",
		method : 'put',
		dataType: 'json',
		data : formData,
		success: function(data){
...
function ChangeLName(info){
	...
	var formData = info;
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/accountlname/",
		method : 'put',
		dataType: 'json',
		data : formData,
		success: function(data){
...
function ChangeShipping(info){
	...
	var formData = info;
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/accountshipping/",
		method : 'put',
		dataType: 'json',
		data : formData,
		success: function(data){
...
function ChangeBilling(info){
	...
	var formData = info;
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/accountbilling/",
		method : 'put',
		dataType: 'json',
		data : formData,
		success: function(data){
...
function ChangeCardNumber(info){
	...
	var formData = info;
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/accountcardnumber/",
		method : 'put',
		dataType: 'json',
		data : formData,
		success: function(data){
...
function ChangeCardType(info){
	...
	var formData = info;
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/accountcardtype/",
		method : 'put',
		dataType: 'json',
		data : formData,
		success: function(data){
...
function ChangeSecurity(info){
	...
	var formData = info;
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/accountsecurity/",
		method : 'put',
		dataType: 'json',
		data : formData,
		success: function(data){
...
function ChangeExpDate(info){
	...
	var formData = info;
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/accountexpdate/",
		method : 'put',
		dataType: 'json',
		data : formData,
		success: function(data){
...
function ChangeEmail(info){
	...
	var formData = info;
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/accountemail/",
		method : 'put',
		dataType: 'json',
		data : formData,
		success: function(data){
...
function ChangeBank(info){
	...
	var formData = info;
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/accountbank/",
		method : 'put',
		dataType: 'json',
		data : formData,
		success: function(data){
...
function InsertBid(id, ibid){
	...
	if(lbid > 0){
		...
		$.mobile.loading("show");
		$.ajax({
			url : "http://lhl.herokuapp.com/LHL/auctionProd/" + id +"/"+lbid,
			method: 'get',
			contentType: "application/json",
			dataType:"json",
			success : function(data, textStatus, jqXHR){
			...
			if(result.length > 0){
				...
				$.ajax({
					url : "http://lhl.herokuapp.com/LHL/addbid",
					type: 'post',
					dataType: 'json',
					data : formData,
					success : function(data){
					...
					$.ajax({
						url : "http://lhl.herokuapp.com/LHL/updateMaxbid",
						type: 'put',
						data : formData,
						success : function(data) {
...
function GetSearch(term){
	...
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/searchAll/"+ term,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
...
function GetSearchSub(term, id){
	...
	$.mobile.loading("show");
	$.ajax({
		url : "http://lhl.herokuapp.com/LHL/searchSub/"+ term+"/"+id,
		method: 'get',
		contentType: "application/json",
		dataType:"json",
		success : function(data, textStatus, jqXHR){
